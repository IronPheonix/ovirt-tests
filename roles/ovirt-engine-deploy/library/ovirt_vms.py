...
options:
    ...
    cloud_init_nics:
        description:
            ...
            - "This option is used, when user need to setup more network interfaces via cloud init."
...
class VmsModule(BaseModule):
    ...
    def __get_template_with_version(self):
        ...
        if self._module.params['template']:
            ...
            templates = [
                t for t in templates_service.list(search='name=%s' % self._module.params['template'])
